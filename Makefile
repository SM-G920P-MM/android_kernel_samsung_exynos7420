...
ARCH		?= arm64
CROSS_COMPILE	?= /home/arter97/gcc-6.1-64/bin/aarch64-none-elf-
...
KBUILD_CFLAGS	+= -pipe -fno-pic -O3 -march=armv8-a+crc -mcpu=cortex-a57.cortex-a53 -mtune=cortex-a57.cortex-a53
